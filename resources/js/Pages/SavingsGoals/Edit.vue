...
const form = useForm({
    ...
    initial_amount: props.goal?.initial_amount || '0.00',
    currency: props.goal?.currency || props.currentAccount?.base_currency || 'USD',
    tracking_mode: props.goal?.tracking_mode || 'net_savings',
    category_id: props.goal?.category_id || '',
    subcategory_id: props.goal?.subcategory_id || '',
    user_id: props.goal?.user_id || '',
    start_date: normalizeDateInput(props.goal?.start_date),
    target_date: normalizeDateInput(props.goal?.target_date),
});
    ...
    <AppLayout :auth="auth" :current-account="currentAccount">
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Edit Savings Goal</h2>
                    <p class="mt-1 text-sm text-gray-600">
                        Update your target and tracking preferences.
                    </p>
                </div>
                <Link
