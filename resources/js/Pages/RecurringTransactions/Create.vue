            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Set up a template that will create normal transactions on schedule.
                    </p>
                </div>
                <Link
            ...
            <form @submit.prevent="submit" class="pf-card">
                <div class="px-6 py-6 space-y-8">
                    <div class="rounded-xl border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-900">
                        The scheduler creates regular transactions from this template. The first generated entry will use the `Next run date` below.
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-6">
                        <div class="lg:col-span-2">
                            ...
                            <p class="mt-2 text-xs text-gray-500">
                                Generated transactions will belong to this user for filters, budgets, and goals.
                            </p>
