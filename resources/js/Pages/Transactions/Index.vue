                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex space-x-2">
                                    <Link
                                        :href="route('transactions.create', { repeat: transaction.id })"
                                        class="text-slate-500 hover:text-slate-900"
                                        title="Repeat transaction"
                                        aria-label="Repeat transaction"
                                    >
                                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h9a2 2 0 012 2v9m-3-11H7a2 2 0 00-2 2v9m2-11V5a2 2 0 012-2h9a2 2 0 012 2v9a2 2 0 01-2 2h-2" />
                                        </svg>
                                    </Link>
