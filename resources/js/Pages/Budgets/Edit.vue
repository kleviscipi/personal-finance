...
const form = useForm({
    ...
    subcategory_id: props.budget?.subcategory_id || '',
    amount: props.budget?.amount || '',
    currency: props.budget?.currency || props.currentAccount?.base_currency || 'USD',
...
form.start_date = normalizeDateInput(
    props.budget?.start_date || new Date().toISOString().slice(0, 10),
);
form.end_date = normalizeDateInput(props.budget?.end_date);
    ...
    <AppLayout :auth="auth" :current-account="currentAccount">
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Edit Budget</h2>
                    <p class="mt-1 text-sm text-gray-600">
                        Update the limits and period for this budget.
                    </p>
                </div>
                <Link
